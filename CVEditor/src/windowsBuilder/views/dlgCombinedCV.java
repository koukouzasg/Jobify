...
public class dlgCombinedCV extends JDialog {
	...
	public static void main(String[] args) {
		try {
			dlgCombinedCV dialog = new dlgCombinedCV();
	...
	private void initCV() {
		...
		this.fCv = new CV("Combined CV", sections);
	...
	private void menuEvents() {
		...
		mntmMerge.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				dlg.setModal(true);
				dlg.setVisible(true);
				dlgCombinedCV.this.setVisible(false);
			}
		});
	}
	...
	private void skillsEvents() {
		...
		btnEdit_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				arrayList = csp.getArrayList();//getTxtText().getText();
	...
	private void furtherCoursesEvents() {
		...
		btnEdit_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				BulletListItem clickedFurtherCourses = furtherCoursesList.getElementAt(lstFurtherCourses.getSelectedIndex());
				//JOptionPane.showMessageDialog(null,lstFurtherCourses.getSelectedIndex());
				...
				.addGroup(gl_contentPanel.createSequentialGroup()
					.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
							...
							.addComponent(txtpnskillAndExperience, GroupLayout.PREFERRED_SIZE, 227, GroupLayout.PREFERRED_SIZE)
							.addGroup(gl_contentPanel.createSequentialGroup()
								.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
